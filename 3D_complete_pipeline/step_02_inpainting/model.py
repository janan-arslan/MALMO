...
with tf.device('/device:GPU:0'):
    def unet(pretrained_weights = None,input_size = (256,256,3)):
        ...
        model.compile(optimizer = Adam(lr = 3e-5), loss = bce_dice_loss, metrics = ['mae','accuracy', dice_coef, dice_coef_loss, precision_m, f1_m, sensitivity_m, specificity_m, mcor])
