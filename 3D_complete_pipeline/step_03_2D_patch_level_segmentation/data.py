...
def testGenerator(test_path,num_image = 1,target_size = (512,512),flag_multi_class = False,as_gray = False):
    for i in range(num_image):
        img = io.imread(os.path.join(test_path,"%d.tif"%i),as_gray = as_gray)
        img = img / 255
        img = trans.resize(img,target_size)
        # For coloured images, comment out the below. For grayscaled images, bring it back. #######################
