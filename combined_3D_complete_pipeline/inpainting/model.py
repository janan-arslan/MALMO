...
def mcor(y_true, y_pred):
    ...
    mcor = numerator / (denominator + K.epsilon())
...
with tf.device('/device:GPU:0'):
    def unet(pretrained_weights = None,input_size = (512,512,3)):
        ...
        model.compile(optimizer = Adam(lr = 3e-5), loss = bce_dice_loss, metrics = ['mae','accuracy', dice_coef, dice_coef_loss, recall_m, precision_m, f1_m, sensitivity_m, specificity_m, jaccard_distance, dice_1, jac, mcor])
